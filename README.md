...
```yaml
Nombre: Carlos Moran
Localizado_en: Sevilla, España
Actualmente: Buscando empleo
Educacion:
  [
    - CFGS Desarrollo de Aplicaciones Web,
    - Docencia para la formacion para el empleo
  ]
Experiencia:
  [
    - Desarrollador Web en HelloAuto
  ]
Trabajando_actualmente_en: ["IA", "automatizacion", "proyectos personales"]
Metas_2026: ["Crear aplicaciones utiles para facilitar la vida a los usuarios"]
Hobbies: ["Deporte", "Videojuegos", "Lectura"]
```
